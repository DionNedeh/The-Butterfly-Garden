...
/**
 * Built once at module load. This table used to be constructed inside the
 * component, so every icon on screen allocated all twenty-five entries and
 * threw twenty-four away — dozens of times per render of the app shell.
 */
